...
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: fill; background-size: cover; width: 130vw; opacity: 0.5; background: url('https://github.com/IkarosKurtz/IkarosKurtz/blob/Master/static/chibi.jpeg?raw=true');]{x0000}$}
```
