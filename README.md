...
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; object-fit: cover; background-size: 30%; height: 100vh;  width: 100vw;  opacity: 0.5; background: url('github.com/IkarosKurtz/IkarosKurtz/blob/Master/static/obed.jpeg?raw=true');]{x0000}$}
```
